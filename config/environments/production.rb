Rails.application.configure do
  ...
  routes.default_url_options = {host: 'https://corona.kalselprov.go.id', protocol: 'https'} # https is necessary!
  ...
  # config.active_job.queue_name_prefix = "covidKalsel_#{Rails.env}"

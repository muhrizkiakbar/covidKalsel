...
ActiveRecord::Schema.define(version: 2020_05_05_082124) do
  ...
  create_table "cities", force: :cascade do |t|
    ...
    t.integer "cov_positive_count", default: 0, null: false
    t.integer "cov_negative_count", default: 0, null: false
    t.integer "cov_recovered_count", default: 0, null: false
    t.integer "cov_died_count", default: 0, null: false
    t.integer "cov_odp_count", default: 0, null: false
    t.integer "cov_pdp_count", default: 0, null: false
    t.string "slug"
    t.datetime "deleted_at"
    t.integer "cov_odp_processed_count", default: 0, null: false

...
ActiveRecord::Schema.define(version: 2020_05_05_082124) do
  ...
  create_table "developpers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_developpers_on_email", unique: true
    t.index ["reset_password_token"], name: "index_developpers_on_reset_password_token", unique: true
    t.index ["username"], name: "index_developpers_on_username", unique: true
  end
  ...
  create_table "telegram_chat_by_usernames", force: :cascade do |t|
    t.bigint "chat_id"
    t.string "first_name"
    t.string "username"
    t.string "kind"
    ...
    t.string "slug"
    t.datetime "deleted_at"
    t.index ["deleted_at"], name: "index_telegram_chat_by_usernames_on_deleted_at"
    t.index ["slug"], name: "index_telegram_chat_by_usernames_on_slug", unique: true
  end

  create_table "telegram_send_chats", force: :cascade do |t|
    t.bigint "chat_id"
    t.text "message"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "slug"
    t.datetime "deleted_at"
    t.index ["deleted_at"], name: "index_telegram_send_chats_on_deleted_at"
    t.index ["slug"], name: "index_telegram_send_chats_on_slug", unique: true
  end
  ...
  add_foreign_key "oauth_access_grants", "developpers", column: "resource_owner_id"
  add_foreign_key "oauth_access_grants", "oauth_applications", column: "application_id"
  add_foreign_key "oauth_access_tokens", "developpers", column: "resource_owner_id"

...
puts "Create Permissions"
 permissions.each_with_index do |permission,key|
    ...
    #   add_permissions= Permission.new
    #   add_permissions.name = permission[:name], #Penamaan gasan permission nya
    #   add_permissions.resource = permission[:resource], #nama file di model harus sama
    #   add_permissions.action = permission[:action], #nama function di controller
    #   add_permissions.description = permission[:description], #gasan penjelasan aja
    #   add_permissions.page = permission[:page], #ini akan bisa di akses di menu atau tidak
    #   add_permissions.path = permission[:path] #path di rails route
    #   add_permissions.save
    # p "============================================"
    # p permission[:name]
